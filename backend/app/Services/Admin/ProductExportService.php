    ...
    public function xml(array $filters = []): string
    {
        ...
        return SpreadsheetXml::document(
            ...
            [
                ...
                'Optional' => '<Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:ReadingOrder="RightToLeft" ss:WrapText="1"/><Font ss:Bold="1" ss:Color="#166534" ss:Size="11"/><Interior ss:Color="#E8EEF8" ss:Pattern="Solid"/>',
            ],
        );
    }
