...
abstract class AppStrings {
  ...
  // ── Phone OTP ──────────────────────────────────────────────────────────────
  static const phoneLoginTitle = 'أدخل الرقم هنا';
  static const phoneLoginSubtitle = '';
  static const phoneLoginHint = '05XXX';
  static const phoneLoginButton = 'متابعة';
  ...
  static const guestCheckoutMessage = 'لإتمام الطلب سجّل دخولك برقم جوالك';
  static const guestOrdersMessage = 'لعرض طلباتك وتتبعها سجّل دخولك أولاً';
  static const guestAddressMessage = 'لحفظ عنوان التوصيل سجّل دخولك أولاً';
  ...
  static const fieldPhoneHint = '05XXX';
  static const fieldPhoneInvalid = 'أدخل رقم جوال صحيح مثل 05XXXXXXXX';
  ...
  static const otpResent = 'تم إرسال رمز جديد.';
  static const otpWhatsappHint = 'أدخل رمز التحقق الذي وصلك.';
  ...
  static const editNameSubtitle = 'سيظهر اسمك بشكل أنيق على طلباتك وحسابك';
  static const editNameSave = 'حفظ الاسم';
  static const editNameFieldLabel = 'الاسم كما تريد أن يظهر';
  static const personalInfoPrivacyNote =
      'بياناتك محفوظة بأمان ولا تُشارك مع أي جهة خارجية.';
  ...
  static const homeSectionFreshGroceriesSubtitle = 'الأقل سعر والأفضل جودة';
  ...
  static const searchTrendingFallback = <String>[
    'حليب طازج',
    'أرز بسمتي',
    'زيت زيتون',
    'دجاج',
  ...
  static const searchSmartFallback = <String>[
    'فطور الدوام',
    'كبسة الغدا',
    'عروض اليوم',
    'خضار وفواكه',
  ...
  static const searchBestOffers = 'أفضل العروض';
  static const searchLegendary = 'عروض أسطورية';
  static const searchLegendaryHint = 'خصومات ما تتفوت — اليوم فقط';
  static const searchClearRecents = 'مسح';
  static const searchNoResults = 'ما لقينا شي بهذا الاسم';
  static const searchNoResultsHint = 'جرّب كلمة ثانية أو اختر من الاقتراحات';
  static const searchResultsCount = 'نتيجة';
  static const dynamicPageEmpty = 'لا توجد منتجات في هذه الصفحة بعد';
  static const dynamicPageFailed = 'تعذّر فتح الصفحة. حاول مجدداً.';
  static const dynamicPageRetry = 'إعادة المحاولة';
  ...
  // ── Product Bundles ────────────────────────────────────────────────────────
  static const bundleOurPrice = 'سعرنا';
  static const bundleAddToCart = 'إضافة السلة';
  static const bundleAddAll = 'إضافة للسلة';
  static const bundleDetailsTitle = 'عرض التوفير';
  static const bundleUnavailable = 'السلة غير متوفرة حالياً';

  static String bundleDiscount(int percent) => 'خصم $percent%';
  static String bundleItemCount(int count) => '$count منتجات';
  static String bundleItemQty(int qty) => 'عدد $qty';
  ...
  static const cartShare = 'مشاركة السلة';
  static const cartNewBadge = 'جديد';
  static const cartCompleteYourCart = 'منتجات تكمل سلتك!';
  static const cartSuggested = 'منتجات مقترحة';
  static const cartProductsInCart = 'المنتجات في السلة';
  static const cartClearAll = 'حذف الكل';
  static const cartClearTitle = 'تفريغ السلة';
  static const cartClearBody = 'هل تريد حذف جميع المنتجات من السلة؟';
  static const cartProceedToCheckout = 'الانتقال للدفع';
  ...
  static const profilePersonalInfo = 'المعلومات الشخصية';
