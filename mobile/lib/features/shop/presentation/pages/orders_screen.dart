...
class _OrderCardState extends State<_OrderCard>
  ...
  static String _itemsSummary(OrderEntity order) {
    final paid = paidCartItems(order.items);
    final names = paid.map((i) => i.product.name).take(3).join('، ');
    final extra = paid.length > 3 ? ' و${paid.length - 3} أخرى' : '';
    return '$names$extra';
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          ...groupedCartItems(order.items).map(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () =>
                  Navigator.of(context).pop(MainShellTabs.categories),
