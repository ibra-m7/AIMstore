...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get profileNotificationsSaveFailed => 'تعذّر حفظ إعداد الإشعارات';

  @override
  String get profilePrivacyAndTerms => 'سياسة الخصوصية والاستخدام';

  @override
  String profileVersionLabel(String version) {
    return 'رقم النسخة: $version';
  }
